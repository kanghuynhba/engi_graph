...
class IngestionService:
    def __init__(self, source_repository, crawl_run_repository, crawler: Crawler, orchestrator, indexing_pipeline):
    ...
    async def crawl_source(self, source_id: int):
        ...
        crawl_run = self.crawl_run_repository.create(source_id)
    ...
    async def process_crawl_run(self, source, crawl_run):
        try:
            ...
            summary = await self.orchestrator.process_urls(source, crawl_run, urls)
